                    ...
                    <div id="loginForm" class="auth-form active">
                        ...
                        <form id="kc-form-login" action="${url.loginAction}" method="post">
                            <div class="input-group mb-3">
                                <input type="text" class="form-input form-control" name="username" placeholder="Nom d'utilisateur ou adresse e-mail" value="${(login.username!'')}" required autofocus>
                            </div>
                            <div class="input-group mb-3">
                        ...
                        <div class="switch-form text-center">
                            ...
                            <a href="https://sosgarage-production-967f.up.railway.app/register" class="link-btn">Créer un compte gratuitement</a>
                        </div>
                    </div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function adjustMobileHeight() {
                if (window.innerWidth <= 768) {
                    document.querySelector('.auth-container').style.minHeight = window.innerHeight + 'px';
                    document.querySelector('.auth-card').style.minHeight = window.innerHeight + 'px';
                }
            }
